...
function initUniversitiesPage() {
    ...
    function renderUnis() {
        ...
        grid.innerHTML += batch.map(function(u) {
            ...
            return '<a href="university-detail?id=' + u._id + '" class="st-card fade-in visible" style="text-decoration:none;">' +
...
function initScholarshipsPage() {
    ...
    function renderSchs() {
        ...
        grid.innerHTML += batch.map(function(s) {
            ...
            return '<a href="scholarship-detail?id=' + s._id + '" class="st-card fade-in visible" style="text-decoration:none;">' +
...
function initNotificationsPage() {
    ...
    var notifications = [], notifShown = 0, NOTIF_BATCH = 10;
    ...
    function renderNotifs() {
        ...
        el.innerHTML += batch.map(function(n) {
            ...
            var thumbHTML = thumb
                ? '<img src="' + resolveAsset(thumb) + '" style="width:100%;height:100%;object-fit:cover;" onerror="this.outerHTML=\'' + entityIcon(entityType).replace(/'/g, "\\'") + '\'">'
...
function initTrackAppPage() {
    initPage('tracking');
    var allApps = [], filteredApps = [], appShown = 0, APP_BATCH = 6;
